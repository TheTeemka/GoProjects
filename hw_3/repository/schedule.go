...
func (sc *ScheduleRepository) GetForStudent(ctx context.Context, studentID int) ([]models.Schedule, error) {
	query := `
...
func (sc *ScheduleRepository) GetAll(ctx context.Context) ([]models.Schedule, error) {
...
func (sc *ScheduleRepository) GetForGroup(ctx context.Context, groupID int) ([]models.Schedule, error) {
	rows, err := sc.conn.Query(
		ctx,
